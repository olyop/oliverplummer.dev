...
export const isSortByFieldValid = (sortByField: string) => skillsSortByFields.includes(sortByField as SortByKey);

export const isSortByDirectionValid = (sortByDirection: string) =>
