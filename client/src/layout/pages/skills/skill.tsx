...
const Skill: FC<Props> = ({ skill }) => (
	<div className="hover:border-primary-accent border-primary flex flex-col items-center gap-4 rounded-lg border px-4 pb-4 pt-5 transition-all duration-300 sm:px-8 sm:pb-8">
