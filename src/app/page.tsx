...
function Lights() {
	return (
		<>
			<div className="absolute left-2 top-14 h-36 w-96 rounded-full bg-primary blur-[7rem] sm:w-80" />
			<div className="absolute bottom-1/2 right-10 h-96 w-36 -rotate-45 rounded-full bg-primary blur-[7rem] sm:w-80" />
			<div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 translate-y-1/2 rotate-12 rounded-full bg-hover blur-[7rem] sm:w-80" />
			<div className="absolute left-0 top-1/2 size-96 -translate-y-1/2 rounded-full bg-hover blur-[7rem] sm:w-80" />
...
function Content() {
	return (
		<div className="z-20 grid items-stretch gap-4 p-4 sm:gap-8 sm:p-0 md:grid-cols-[30rem,15rem] md:grid-rows-[40rem,15rem]">
			<div className="z-20 space-y-8 rounded-3xl bg-elevated-hsla-low p-4 shadow backdrop-blur-lg sm:p-8">
				...
				<p className="leading-6">
					<i>
						Creative Software Developer with 2 years of professional experience, bringing
						flair to dynamic interfaces and crafting innovative solutions that enhance
						user satisfaction. I love to build things, tackling everything from
...
function Location() {
	return (
		<div className="rounded-3xl bg-elevated-hsla-low p-4 shadow backdrop-blur-lg sm:p-8">
			<p>
				<u>Location:</u>
			</p>
			<p>
